...
export const memberRegistrationSchema = z
  .object({
    ...
    validation_method: z.enum(VALIDATION_METHODS, { required_error: requiredMessage }),
    ...
    data_consent: z.coerce.boolean().refine(Boolean, "Debes autorizar el uso de datos para administrar la membresía."),
